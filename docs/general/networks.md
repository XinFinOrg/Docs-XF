...
XinFin Network, a independent public blockchain, the most efficient platform for the token economy

### Specifications

- Chain id: `853`
- RPC endpoint: `https://testnet.xinfin.org`
- Websocket endpoint: `wss://ws.xinfin.org`
- Metrics endpoint: `https://metrics.xinfin.org`
...
- [Status page](https://stats.xinfin.org)
- [TomoScan](https://scan.xinfin.org) (Block explorer)
- [TomoMaster](https://master.xinfin.org) (Governance dApp)
...
- Chain id: `89`
- RPC endpoint: `https://testnet.xinfin.org`
- Websocket endpoint:  `wss://testnet.xinfin.org/ws`
- Metrics endpoint: `https://metrics.testnet.xinfin.org`
- HD derivation path: `m/44'/889'/0'/0/`
- Consensus: POSV
- Block finality: `>75%`
- Consensus nodes: up to 150 (masternodes)
...
- [Status page](https://stats.testnet.xinfin.org)
- [TomoScan](https://scan.testnet.xinfin.org) (Block explorer)
- [TomoMaster](https://master.testnet.xinfin.org) (Governance dApp)
- [TomoWallet](https://wallet.testnet.xinfin.org) (Wallet dApp)
- [Faucet](https://faucet.testnet.xinfin.org) (Free testnet TOMO)
