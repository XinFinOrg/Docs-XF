...
* 2 XinFin Network wallets (addresses) - [see details below](#7-create-wallet-addresses)
...
If you need help with this, [see this example](https://medium.com/XinFin Network/how-to-run-a-XinFin Network-masternode-from-a-to-z-3793752dc3d1#6122).
...
If you need help with this, [see this example](https://medium.com/XinFin Network/how-to-run-a-XinFin Network-masternode-from-a-to-z-3793752dc3d1#20a7).
...
We will now prepare the [prerequisites for tmn](https://docs.xinfin.org/get-started/run-node/).
...
[Look at our wiki security doc for more details](https://github.com/XinFin Network/docs/wiki/Security-of-Masternodes)
...
`Tmn` is a simple interface created by XinFin Network developers to **help you quickstart your masternode**.
It is installed as a python package and it utilizes two docker containers once operating.
We will follow through the steps found here: [guide to install tmn](https://docs.xinfin.org/get-started/run-node/)

> “We made a simple command line interface called tmn to easily and quickly start a XinFin Network masternode.
...
Install and update the XinFin Network-created `tmn` utility from pip:
...
Home-page: https://xinfin.org
Author: Etienne Napoleone
Author-email: etienne@xinfin.org
License: GPL-3.0+
...
* [Using Metamask or Mobile Tomo Wallet](https://docs.xinfin.org/get-started/wallet/)
* [Links to mobile downloads and other tomo info](https://medium.com/XinFin Network/XinFin Network-all-in-one-overview-9fce16e13b5#6b8c)
* [Old Masternode guide (testnet) Section on wallets](https://medium.com/XinFin Network/how-to-run-a-XinFin Network-masternode-from-a-to-z-3793752dc3d1#0e58)
<br/>
...
You can choose here to connect it to the XinFin Network `mainnet` or `testnet`.  
>  
> **--pkey:** The private key of your WALLET1 wallet (non 50k).
A XinFin Network full node uses a wallet address to be uniquely identified and to receive transaction fees.
...
Contents to come: `tmn status`; `tmn inspect`; `top` command; https://stats.xinfin.org/ website; # of blocks command; `tmn update`, `tmn --help`, etc
<br/>
...
[Full Jumpstart instructions can be found here](https://github.com/XinFin Network/docs/wiki/Update-stuck-node-or-Jumpstart-chain-sync)
...
This section coming soon.
[For now, see here](https://docs.xinfin.org/get-started/apply-node/)
...
Contents to come: https://master.xinfin.org/ ; login as 50k wallet; find your MN; edit; enter name; sign data
<br/>
...
Contents to come: https://master.xinfin.org/ ; https://scan.xinfin.org/ ; explain infra vs stake reward; link to economics
...
# Enact Jumpstart: https://github.com/XinFin Network/docs/wiki/Update-stuck-node-or-Jumpstart-chain-sync
```
